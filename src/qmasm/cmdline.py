...
class ParseCommandLine(object):
    def parse_command_line(self):
        ...
        cl_parser.add_argument("--format", choices=["qubist", "ocean", "qbsolv", "qmasm", "numpy", "minizinc", "bqpjson"], default="qubist",
        ...
        cl_parser.add_argument("--solver", type=str, default=None, metavar="NAME",
                               help='Solver name from dwave.conf to use or one of the special names "exact", "sim_anneal", "tabu", "greedy", "kerberos[,<solver>]", or "qbsolv[,<solver>]"')
